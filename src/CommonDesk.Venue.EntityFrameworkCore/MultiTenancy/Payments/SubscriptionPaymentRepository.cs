...
using CommonDesk.Venue.EntityFrameworkCore.Repositories;

namespace CommonDesk.Venue.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : VenueRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<VenueDbContext> dbContextProvider)
