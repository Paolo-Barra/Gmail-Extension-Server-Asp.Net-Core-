...
using CommonDesk.Venue.MultiTenancy.Accounting;
using CommonDesk.Venue.MultiTenancy.Payments;
using CommonDesk.Venue.Storage;

namespace CommonDesk.Venue.EntityFrameworkCore
{
    public class VenueDbContext : AbpZeroDbContext<Tenant, Role, User, VenueDbContext>, IAbpPersistedGrantDbContext
    {
