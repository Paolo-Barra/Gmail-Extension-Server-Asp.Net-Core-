...
using CommonDesk.Venue.Web.Configuration;

namespace CommonDesk.Venue.Web
{
    [DependsOn(
        typeof(VenueApplicationModule),
        typeof(VenueEntityFrameworkCoreModule),
    ...
    public class VenueWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public VenueWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.DefaultNameOrConnectionString = _appConfiguration.GetConnectionString(
                VenueConsts.ConnectionStringName
            );
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(VenueApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(VenueWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(VenueWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
