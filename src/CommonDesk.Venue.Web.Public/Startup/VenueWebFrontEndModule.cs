...
namespace CommonDesk.Venue.Web.Public.Startup
{
    [DependsOn(
        typeof(VenueWebCoreModule)
    )]
    public class VenueWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public VenueWebFrontEndModule(IHostingEnvironment env, VenueEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(VenueWebFrontEndModule).GetAssembly());
        }
    }
}
