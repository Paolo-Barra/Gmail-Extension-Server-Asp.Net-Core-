...
using CommonDesk.Venue.Web.Public.Startup;
using CommonDesk.Venue.Web.Session;

namespace CommonDesk.Venue.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : VenueViewComponent
    {
