...
using MvvmHelpers;
using CommonDesk.Venue.Authorization.Users.Profile;
using CommonDesk.Venue.Authorization.Users.Profile.Dto;
using CommonDesk.Venue.Commands;
using CommonDesk.Venue.Core.Threading;
using CommonDesk.Venue.Models.NavigationMenu;
using CommonDesk.Venue.Services.Navigation;
...
using CommonDesk.Venue.Controls;
using CommonDesk.Venue.Dto;
using CommonDesk.Venue.Extensions;
using CommonDesk.Venue.Localization;
using CommonDesk.Venue.UI;
using CommonDesk.Venue.UI.Assets;
using CommonDesk.Venue.Views;
using DependencyResolver = CommonDesk.Venue.Core.Dependency.DependencyResolver;
...
namespace CommonDesk.Venue.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Venue";
