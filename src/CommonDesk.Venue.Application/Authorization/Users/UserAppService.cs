...
using CommonDesk.Venue.Authorization.Permissions;
...
namespace CommonDesk.Venue.Authorization.Users
{
    ...
    public class UserAppService : VenueAppServiceBase, IUserAppService
    {
        ...
        // // COMMONDES: Return a user by its user account id
        // [HttpGet]
        // public bool IsUserRegistered(GetUserByUserAccountIdInput input) 
        // {
        //     var user = UserManager.GetUserByUserAccountId(input.ProviderId, input.UserAccountId);
        //     return user != null;
        // }  
    }      
}
