...
using CommonDesk.Venue.Authorization.Users.Profile.Cache;
using CommonDesk.Venue.Authorization.Users.Profile.Dto;
using CommonDesk.Venue.Friendships;
using CommonDesk.Venue.Gdpr;
using CommonDesk.Venue.Identity;
using CommonDesk.Venue.Net.Sms;
using CommonDesk.Venue.Security;
using CommonDesk.Venue.Storage;
using CommonDesk.Venue.Timing;

namespace CommonDesk.Venue.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : VenueAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("CommonDesk.Venue",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("CommonDesk.Venue",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
