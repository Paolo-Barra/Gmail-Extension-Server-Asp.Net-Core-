...
namespace CommonDesk.Venue.Authorization.Accounts
{
    public class AccountAppService : VenueAppServiceBase, IAccountAppService
    {
        ...
        public async Task<RegisterOutput> Register(RegisterInput input)
        {
            ...
            var user = await _userRegistrationManager.RegisterAsync(
                ...
                // COMMONDESK - Admin users or non-oauth users don't need a valid userAccountId
                ""
            );
