...
using CommonDesk.Venue.Auditing.Exporting;
...
using EntityHistoryHelper = CommonDesk.Venue.EntityHistory.EntityHistoryHelper;

namespace CommonDesk.Venue.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : VenueAppServiceBase, IAuditLogAppService
    {
