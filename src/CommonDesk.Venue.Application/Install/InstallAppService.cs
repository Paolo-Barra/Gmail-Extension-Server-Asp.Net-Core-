...
using CommonDesk.Venue.Migrations.Seed.Host;
...
namespace CommonDesk.Venue.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : VenueAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<VenueDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(VenueConsts.ConnectionStringName).Value.ToString();
        }
