...
using CommonDesk.Venue.Core.Base;
using CommonDesk.Venue.Core.Extensions;
using CommonDesk.Venue.Dto;
using CommonDesk.Venue.Types;

namespace CommonDesk.Venue.Queries
{
    public class OrganizationUnitQuery : VenueQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
