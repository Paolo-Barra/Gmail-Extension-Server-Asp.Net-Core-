...
import { NgxBootstrapLocaleMappingService } from '../ngx-bootstrap/ngx-bootstrap-locale-mapping.service';
import { defineLocale } from 'ngx-bootstrap/chronos';
import { ThemeHelper } from '../../../../../src/app/shared/layout/themes/ThemeHelper';
...
export class NgxBootstrapDatePickerConfigService {
    ...
    static registerNgxBootstrapDatePickerLocales(): Promise<boolean> {
        ...
        var x = abp.localization.currentLanguage;
        if (abp.localization.currentLanguage.name === undefined)
        {
