...
import { FreeSignupComponent } from './signup/free-signup/free-signup.component';
import { CompanySignupComponent } from './signup/company-signup/company-signup.component';

// defines routes in /account/xxxxx
@NgModule({
    imports: [
        RouterModule.forChild([
            {
                ...
                data: { preload: true },
                children: [
                    { path: 'login', component: LoginComponent, canActivate: [AccountRouteGuard], data: { isAdminLogin: false } },
                    { path: 'login-admin', component: LoginComponent, canActivate: [AccountRouteGuard], data: { isAdminLogin: true } },
                    { path: 'start', component: StartComponent, canActivate: [AccountRouteGuard] },
                    { path: 'create', component: SignUpComponent, canActivate: [AccountRouteGuard] },
                    { path: 'signup', component: SignupComponent, canActivate: [AccountRouteGuard] },
                    { path: 'signup/company', component: CompanySignupComponent, canActivate: [AccountRouteGuard] },
