...
// Note: There are two SharedModule.  Take the one from ./ not .
// From Merge
//import { SharedModule } from 'shared.module';

//import { RefindRootModule } from '@refindRoot/refindRoot.module';
import { SharedModule } from './shared.module';
import { InvalidComponent } from '@shared/invalid/invalid.component';
import { ModuleWithProviders } from '@angular/core';
// //COMMONDESK
// import {ACCOUNT_REGISTRATION, AccountRegistration} from "@app/refind/rest/registration";
...
function initializeLocalForage() {
    localForage.config({
        ...
        description: 'Cached data for Venue'
    });
}
...
@NgModule({})
export class RefindFullAppSharedModule {
