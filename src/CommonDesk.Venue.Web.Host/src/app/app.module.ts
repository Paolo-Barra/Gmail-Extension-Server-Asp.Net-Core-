...
// import { MatStepperModule, MatRadioModule, MatSelectModule, MatInputModule, MatCheckboxModule } from '@angular/material';
...
import { RefindModule } from './refind/refind.module';
import { AccountCreationProgressComponent } from '@refindRoot/account-creation-progress/account-creation-progress.component';
...
import { OAuthService, UrlHelperService, OAuthModule, OAuthLogger } from 'angular-oauth2-oidc';
import { GroupByPipe } from '../groupBy.pipe';
import { RefindDashboardComponentGmail } from './refind/dashboard/refind.dashboard.component';
import { RecipesPageComponentLogic } from './refind/recipes/recipes-inuse/recipes-inuse-logic.component';
import { RecipeCreateOrEditComponentLogic } from './refind/recipes/recipesCreateOrEdit/recipes-CreateOrEditLogic.component';
import { DevicesLogicComponent } from './refind/devices/devices.logic.component';
import { WelcomeComponent } from './refind/welcome/welcome.component';
...
@NgModule({
    declarations: [
        ...
        AccountCreationProgressComponent,
        PostCreateOauthLandingPageComponent,
        PostLoginOauthLandingPageComponent,
        PostLoginOauthLandingPageComponentMobile,
        PostLoginOauthLandingPageComponentGmail,
        LoginComponentMobile,
        RefindDashboardComponentGmail,
        LoginComponentGmail,
        //WelcomeComponent
    ],
    imports: [
