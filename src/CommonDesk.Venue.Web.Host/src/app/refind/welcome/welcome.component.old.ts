...
// import * as RefindTypes from '@shared/service-proxies/refind/ReFind.dtos';
...
//   {  
//     var ud = this.dataService.getAuthUserDetails();
...
//     var response =  await this.refindServiceProxyTyped.AddAccount(
//         ud.MailAccountId,
//         ud.EmailAddress,
//         ud.MailServer,
//         ud.MailAccountType,
...
//         ud.Expiration,
//         "",
//         RefindTypes.OAuthAccessTokenType.AccessCode
//     );
...
//     else
//     {
//       this.tools.info("Error="+response.Message);
//     }
//     this.IsAccountCreationRunning = false;
//   }  
