...
export class TokenAuthServiceProxy {
     ...
     * @param userAccountId (optional) 
     * @return Success
     */
    isUserRegistered(providerId: string | null | undefined, userAccountId: string | null | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/TokenAuth/IsUserRegistered?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processIsUserRegistered(<any>response_);
                } catch (e) {
    ...
    protected processIsUserRegistered(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class ApplicationInfoDto implements IApplicationInfoDto {
    ...
    toJSON(data?: any) {
        ...
        data["gitInfo"] = this.gitInfo;
        data["gitBranch"] = this.gitBranch;
        data["gitCommit"] = this.gitCommit;
        data["gitRoot"] = this.gitRoot;
...
export class ExternalAuthenticateModel implements IExternalAuthenticateModel {
    ...
    returnUrl!: string | undefined;
    singleSignIn!: boolean | undefined;
    reFindUserAccountId!: string | undefined;
    ...
    init(data?: any) {
        if (data) {
            ...
            this.returnUrl = data["returnUrl"];
            this.singleSignIn = data["singleSignIn"];
            this.reFindUserAccountId = data["reFindUserAccountId"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["returnUrl"] = this.returnUrl;
        data["singleSignIn"] = this.singleSignIn;
        data["reFindUserAccountId"] = this.reFindUserAccountId;
        return data; 
    }
}
