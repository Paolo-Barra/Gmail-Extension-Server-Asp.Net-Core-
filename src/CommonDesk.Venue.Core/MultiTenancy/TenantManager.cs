...
using CommonDesk.Venue.MultiTenancy.Demo;
...
namespace CommonDesk.Venue.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(VenueConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
