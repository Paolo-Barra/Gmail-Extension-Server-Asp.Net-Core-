...
namespace CommonDesk.Venue.MultiTenancy.Payments.Stripe
{
    //TODO: We may use a retry mechanism using the Poly library.

    public class StripeGatewayManager : VenueServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Venue";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + VenueConsts.Currency;
        }
