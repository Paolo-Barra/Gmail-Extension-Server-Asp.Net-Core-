...
namespace CommonDesk.Venue.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : VenueServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("CommonDesk.Venue", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
