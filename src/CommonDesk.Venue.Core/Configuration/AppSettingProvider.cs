...
namespace CommonDesk.Venue.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!VenueConsts.AllowTenantsToChangeEmailSettings)
            {
        ...
        private IEnumerable<SettingDefinition> GetTenantSettings()
        {
            return new[]
            {
                ...
                // COMMONDESK - Changed false to True
                new SettingDefinition(AppSettings.UserManagement.IsNewRegisteredUserActiveByDefault, GetFromAppSettings(AppSettings.UserManagement.IsNewRegisteredUserActiveByDefault, "true"), scopes: SettingScopes.Tenant),
//                new SettingDefinition(AppSettings.UserManagement.IsNewRegisteredUserActiveByDefault, GetFromAppSettings(AppSettings.UserManagement.IsNewRegisteredUserActiveByDefault, "false"), scopes: SettingScopes.Tenant),
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings, GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings, VenueConsts.MultiTenancyEnabled? "true":"false"), scopes: SettingScopes.Tenant)
            };
        }
		...
		// COMMONDESK
                new SettingDefinition(AppSettings.RefindSettings.AspNetZeroBackendURL, GetFromAppSettings("ServerRootAddress"), isVisibleToClients: true),
                new SettingDefinition(AppSettings.RefindSettings.venueServiceBaseURL, GetFromSettings("VenueServiceBaseURL"), isVisibleToClients: true),
                new SettingDefinition(AppSettings.RefindSettings.venueServerSideEventsRoot, GetFromSettings("VenueServerSideEventsRoot"), isVisibleToClients: true),
                new SettingDefinition(AppSettings.RefindSettings.refindCreateOAuthRedirectUrl, GetFromSettings("RefindCreateOAuthRedirectUrl"), isVisibleToClients: true),
                new SettingDefinition(AppSettings.RefindSettings.refindLoginOAuthRedirectUrl, GetFromSettings("RefindLoginOAuthRedirectUrl"), isVisibleToClients: true),
                new SettingDefinition(AppSettings.RefindSettings.refindLoginOAuthRedirectUrlMobile,GetFromSettings("RefindLoginOAuthRedirectUrlMobile"), isVisibleToClients: true),
                new SettingDefinition(AppSettings.RefindSettings.refindLoginOAuthRedirectUrlGmail,GetFromSettings("RefindLoginOAuthRedirectUrlGmail"), isVisibleToClients: true),
                new SettingDefinition(AppSettings.RefindSettings.logoutUrl,GetFromSettings(AppSettings.RefindSettings.logoutUrl), isVisibleToClients: true),
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetTheme4Settings()
        {
            ...
            {
            new SettingDefinition(themeName + "." + AppSettings.UiManagement.LayoutType, GetFromAppSettings(themeName + "." + AppSettings.UiManagement.LayoutType, "fluid"), isVisibleToClients: true, scopes: SettingScopes.All),
            new SettingDefinition(themeName + "." + AppSettings.UiManagement.FixedBody, GetFromAppSettings(themeName + "." + AppSettings.UiManagement.FixedBody, "true"), isVisibleToClients: true, scopes: SettingScopes.All),
            new SettingDefinition(themeName + "." + AppSettings.UiManagement.MobileFixedBody, GetFromAppSettings(themeName + "." + AppSettings.UiManagement.MobileFixedBody, "true"), isVisibleToClients: true, scopes: SettingScopes.All)
          };
        }
