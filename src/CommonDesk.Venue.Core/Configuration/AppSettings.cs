namespace CommonDesk.Venue.Configuration
{
    ...
    public static class AppSettings
    {
        ...
        // COMMONDESK
        public static class RefindSettings
        {            
            public const string AspNetZeroBackendURL = "AspNetZeroBackendURL";
            public const string venueServiceBaseURL = "VenueServiceBaseURL";
            public const string venueServerSideEventsRoot = "VenueServerSideEventsRoot";
            public const string refindCreateOAuthRedirectUrl = "RefindCreateOAuthRedirectUrl";
            public const string refindLoginOAuthRedirectUrlMobile = "RefindLoginOAuthRedirectUrlMobile";
            public const string refindLoginOAuthRedirectUrlGmail = "RefindLoginOAuthRedirectUrlGmail";
            public const string refindLoginOAuthRedirectUrl = "RefindLoginOAuthRedirectUrl";
