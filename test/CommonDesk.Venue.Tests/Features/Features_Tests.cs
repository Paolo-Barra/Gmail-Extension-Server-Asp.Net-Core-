...
using CommonDesk.Venue.Features;
using CommonDesk.Venue.Test.Base;
using Shouldly;
using Xunit;

namespace CommonDesk.Venue.Tests.Features
{
    ...
    public class Features_Tests : AppTestBase
    {
        ...
        public async Task Should_Not_Create_User_More_Than_Allowed_Count()
        {
            ...
            exception.Message.ShouldContain(_localizationManager.GetString(VenueConsts.LocalizationSourceName, "MaximumUserCount_Error_Message"));
        }
    }
}
