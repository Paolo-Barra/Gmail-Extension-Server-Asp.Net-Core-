...
using CommonDesk.Venue.MultiTenancy.HostDashboard;
...
namespace CommonDesk.Venue.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(VenueDbContext context, SubscriptionPayment subscriptionPayment)
        {
